...
namespace ShiftFlow.Migrations
{
    ...
    [Migration("20260912195512_AddJoinCodeToOrganization")]
    partial class AddJoinCodeToOrganization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShiftFlow.Models.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ShiftFlow.Models.Entities.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ShiftFlow.Models.Entities.OrganizationMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ShiftFlow.Models.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ShiftFlow.Models.Entities.OrganizationMember", b =>
                {
                    b.HasOne("ShiftFlow.Models.Entities.Department", "Department")
                        .WithMany()
                    ...
                    b.HasOne("ShiftFlow.Models.Entities.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
